...
const requireSigin = passport.authenticate('local', { session: false }) // Checks user login details
...
router.post('/login', requireSigin, (req, res) => {
...
router.get('/protectedrouteexample', requireAuth, (req, res) => {
